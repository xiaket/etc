...
vim.api.nvim_create_autocmd("InsertEnter", {pattern = "*", callback = function() relativeln("number") end, once = true, group = _group})
vim.api.nvim_create_autocmd("InsertLeave", {pattern = "*", callback = function() relativeln("relativenumber") end, once = true, group = _group})
vim.api.nvim_create_autocmd("FocusLost", {pattern = "*", callback = function() relativeln("number") end, once = true, group = _group})
vim.api.nvim_create_autocmd("CursorMoved", {pattern = "*", callback = function() relativeln("relativenumber") end, once = true, group = _group})
