...
export PATH="$altdir/bin:${HOME}/.xiaket/etc/bin:${HOME}/.xiaket/go/bin:/usr/local/opt/ruby/bin:/usr/local/bin:/usr/local/sbin:/bin:/usr/bin:/usr/sbin:/sbin:${HOME}/.cargo/bin:/usr/local/opt/coreutils/bin:/usr/local/opt/fzf/bin:/Users/kaixia/Library/Python/3.9/bin"
